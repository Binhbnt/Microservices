...
function DashboardPage() {
  ...
  if (loading) return <div className="p-5 text-center"> <i className="fas fa-spinner fa-spin me-2"></i> Đang tải dữ liệu...</div>;
    ...
    <div className="p-4 dashboard-page">
      ...
      {canViewOverview && (
        <>
          ...
          <h2 className="dashboard-section-title">Tổng quan Đơn từ</h2>
          ...
          <div className="card shadow-sm p-3 mb-5">
            <h5 className="mb-3 text-muted fw-light">Biểu đồ số đơn theo ngày (30 ngày qua)</h5>
            {Array.isArray(stats.dailyCounts) && stats.dailyCounts.length > 0 ? (
              ...
              <div className="text-center p-5 text-muted fst-italic">Không có dữ liệu để vẽ biểu đồ.</div>
            )}
          </div>
        </>
      )}
