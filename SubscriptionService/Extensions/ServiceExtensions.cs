...
namespace SubscriptionService.Extensions
{
    public static class ServiceExtensions
    {
        public static void AddAppServices(this IServiceCollection services, IConfiguration config)
        {
            ...
            services.AddScoped<INotificationService, N8nNotificationService>();
            services.AddHostedService<SubscriptionExpiryNotifier>();
            ...
            {
                client.BaseAddress = new Uri(config["ServiceUrls:NotificationApi"]!);
            });
